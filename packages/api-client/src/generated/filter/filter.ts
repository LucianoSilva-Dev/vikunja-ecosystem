 ...
 */
export const putFilters = (
    
 options?: SecondParameter<typeof customInstance<ModelsSavedFilter>>,) => {
      return customInstance<ModelsSavedFilter>(
      {url: `/filters`, method: 'PUT'
    },
      options);
    }
  /**
 ...
 */
export const deleteFiltersId = (
    id: number,
 options?: SecondParameter<typeof customInstance<ModelsSavedFilter>>,) => {
      return customInstance<ModelsSavedFilter>(
      {url: `/filters/${id}`, method: 'DELETE'
    },
      options);
    }
  /**
 ...
 */
export const getFiltersId = (
    id: number,
 options?: SecondParameter<typeof customInstance<ModelsSavedFilter>>,) => {
      return customInstance<ModelsSavedFilter>(
      {url: `/filters/${id}`, method: 'GET'
    },
      options);
    }
  /**
 ...
 */
export const postFiltersId = (
    id: number,
 options?: SecondParameter<typeof customInstance<ModelsSavedFilter>>,) => {
      return customInstance<ModelsSavedFilter>(
      {url: `/filters/${id}`, method: 'POST'
    },
      options);
    }
...
export type PutFiltersResult = NonNullable<Awaited<ReturnType<typeof putFilters>>>
export type DeleteFiltersIdResult = NonNullable<Awaited<ReturnType<typeof deleteFiltersId>>>
export type GetFiltersIdResult = NonNullable<Awaited<ReturnType<typeof getFiltersId>>>
export type PostFiltersIdResult = NonNullable<Awaited<ReturnType<typeof postFiltersId>>>
