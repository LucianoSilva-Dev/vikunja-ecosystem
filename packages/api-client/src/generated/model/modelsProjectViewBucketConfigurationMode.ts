 ...
 */
export type ModelsProjectViewBucketConfigurationMode = typeof ModelsProjectViewBucketConfigurationMode[keyof typeof ModelsProjectViewBucketConfigurationMode];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ModelsProjectViewBucketConfigurationMode = {
  none: 'none',
  manual: 'manual',
  filter: 'filter',
} as const;
